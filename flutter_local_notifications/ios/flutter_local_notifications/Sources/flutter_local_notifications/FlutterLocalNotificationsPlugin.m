...
NSString *const CUSTOM_REPEAT_INTERVAL = @"customRepeatInterval";
NSString *const DAYS_OF_WEEK = @"daysOfWeek";
NSString *const START_TIME = @"startTime";
NSString *const END_TIME = @"endTime";
...
+ (BOOL)isOnValidWeekDay:(NSTimeInterval)notificationTriggerTime
