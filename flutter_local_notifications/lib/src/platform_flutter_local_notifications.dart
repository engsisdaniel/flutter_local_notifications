...
class AndroidFlutterLocalNotificationsPlugin
  ...
  Future<void> periodicallyShow(
    ...
    String payload,
    bool androidAllowWhileIdle = false,
    DateTime initialDate = null // Data de início para disparo do alarme
    int repeatMinutes = null, // Quantidade de minutos que deve-se esperar até o próximo alarme
  }) async {
    validateId(id);
    final Map<String, Object> serializedPlatformSpecifics =
        notificationDetails?.toMap() ?? <String, Object>{};
    ...
    await _channel.invokeMethod('periodicallyShow', <String, Object>{
      ...
      'title': title,
      'body': body,
      'calledAt': initialDate?.millisecondsSinceEpoch ?? DateTime.now().millisecondsSinceEpoch,
